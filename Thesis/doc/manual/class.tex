...
\label{cha:kulemt}
The document class \cls{kulemt} can be used to generate a master's thesis
...
\item[master=\meta{id\,}]\optionlabelnote{required document class option}\\
  ...
  Engineering are enumerated in \Sref{sec:mastercfg}.
...
\item[masteroption=\meta{mo}]\optionlabelnote{once-only option}\\
  ...
  Faculty of Engineering are enumerated in \Sref{sec:mastercfg}. If a text is
  used for \meta{mo}, it must start with the appropriate word in lower case:
  ...
  mentioned above, if \meta{mo} contains spaces, you can't use this as a
  ...
  in \Sref{sec:mastercfg}. \NewInVersion{1.7}%
  ...
  single text, the \meta{mo} can be replaced by a comma separated list of
  \meta{mo}s. Each of these list elements can either be an abbreviation or a
  full text.
...
\item[assessor=\meta{assessors}]
  \optionlabelnote{required unrestricted option}\\
  This option lists the \meta{assessors} of the thesis separated by a command
  \cs{and}. The name of each assessor is preceded by his/her title unless
...
\item[assistant=\meta{assistants}]
  ...
  separated by a command \cs{and}. For mentors from other universities or
...
a separate page\,\footnote{The option \opt{frontpagesonly} can be used to print
...
\item[translatedtitle=\meta{title2\,}]
  \optionlabelnote{required unrestricted option}\\
  The faculty requires a translated title \meta{title2\,} for Dutch master's
  ...
  a translated title. In this case \meta{title2\,} should be set to an empty
...
\item[udc=\meta{UDC nr}]\optionlabelnote{required unrestricted option}\\
  The\meta{UDC nr} can be obtained either from your master's programme
...
\item[articletitle=\meta{arttitle}]\optionlabelnote{unrestricted option}\\
  ...
  provides the title \meta{arttitle} of the article for printing on the filing
  card.
\end{labelled}
